...
const stats = [
{ value: '8', label: 'Categorias de ocorrência' },
{ value: '24/7', label: 'Registro disponível' },
{ value: 'Prédio I & II', label: 'Cobertura do campus' },
...
Um canal para estudantes reportarem problemas do campus.
...
<span className="text-xs sm:text-sm text-gray-500">Av. Luís Viana Filho, 6775 — Trobogy, Salvador-BA</span>
</div>
