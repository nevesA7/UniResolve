...
import {
  ArrowRight, BookOpen, CheckCircle, Clock, MessageSquare,
  Zap, Shield, BarChart3, MapPin, ChevronRight
} from 'lucide-react'
...
const stats = [
  ...
  { value: '1.2k+', label: 'Chamados resolvidos' },
  { value: '4.8★', label: 'Satisfação dos alunos' },
]
    ...
    <div className="min-h-screen bg-surface text-gray-100">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-surface-border">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display font-bold text-white text-sm">UJResolve</span>
            <span className="hidden sm:block text-xs text-gray-500 ml-1">· Campus Paralela</span>
          </div>
          <button
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-uj-600/8 rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-uj-600/10 border border-uj-600/20 rounded-full px-3 py-1 text-xs text-uj-400 mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-uj-400 animate-pulse-slow" />
              Unijorge · Campus Paralela, Salvador — BA
            </div>
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              O UJResolve é o canal oficial de comunicação entre estudantes e a gestão da Unijorge.
              Registre ocorrências no campus e acompanhe cada etapa da resolução.
            </p>
          ...
          <motion.div
            ...
            className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-px bg-surface-border rounded-xl overflow-hidden"
          >
      ...
      <section className="py-20 px-6 border-t border-surface-border">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-medium text-uj-400 uppercase tracking-widest mb-3">Como funciona</p>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {steps.map((step, i) => (
              ...
              >
                <div className="text-4xl font-display font-bold text-uj-600/20 mb-4 select-none">
                  {step.number}
                </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-medium text-uj-400 uppercase tracking-widest mb-3">Benefícios</p>
            <h2 className="font-display font-bold text-2xl sm:text-3xl text-white">
              Um campus melhor para todos
            </h2>
          </div>
      ...
      <section className="py-20 px-6 border-t border-surface-border">
        <div className="max-w-2xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-500">Av. Luís Viana, 6775 — Paralela, Salvador-BA</span>
          </div>
      ...
      <footer className="border-t border-surface-border px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500">UJResolve · Centro Universitário Jorge Amado</span>
          </div>
